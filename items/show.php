...
<div class="box container">
    <p><a href="<?php echo WEB_ROOT; ?>">Home</a> > <a href="#">Browse Items</a> > Show</p>

    <header>
        <h2><?php echo metadata('item', array('Dublin Core', 'Title')); ?></h2>
         <p><?php echo metadata('item', array('Dublin Core', 'Type')); ?>, <?php echo metadata('item', array('Dublin Core', 'Date')); ?> </p>
         </header>
         <hr />
